...
const Result = () => {
  ...
  return (
    ...
    viewport={{ once: true }} onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] justify-center
items-center'>
      <div>
      ...
      {!isImageLoaded && <div className='flex w-full max-w-xl bg-neutral-500 text-white
